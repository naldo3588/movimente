...
public class JDParcelas extends javax.swing.JDialog {
     ...
     */
    public JDParcelas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
//        lookandfell();
        jFormattedTextFieldNumContrato.setText(String.valueOf(JDAPM.id_contrato));
        jFormattedTextFieldQTDParcelas.setText(String.valueOf(JDAPM.qtd_parcelas));
        jFormattedTextFieldValorMensalidade.setText(String.valueOf(JDAPM.valor_mensalidade));
        jFormattedTextFieldValorContrato.setText(String.valueOf(JDAPM.valor_total_contrato));
