 ...
 */
public class JDCRUDBanco extends javax.swing.JDialog {
     ...
     */
    public JDCRUDBanco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        bloquearCampos();
        lookandfell();
...
//            jDateChooserDataNasc.setDateFormatString(JTableAlunos.getValueAt(indiceLinha, 8).toString());
            ...
            Logger.getLogger(JDCRUDBanco.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        jTextFieldNome.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDCRUDBanco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDCRUDBanco dialog = new JDCRUDBanco(new javax.swing.JFrame(), true);
