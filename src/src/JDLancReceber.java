 ...
 */
public class JDLancReceber extends javax.swing.JDialog {
     ...
     */
    public JDLancReceber(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        lookandfell();
    ...
    private void initComponents() {
        ...
        setTitle("Movi Mente - Contas a Receber");
    ...
    private boolean validarCampos() {
        ...
        } else if (jSpinnerValor.getValue().equals(0)) {
            JOptionPane.showMessageDialog(rootPane, "Valor não pode ser Vazio ou igual a 0 !!");
            jSpinnerValor.requestFocus();
...
//                    conta.setValor(Double.parseDouble(jSpinnerValor.getValue().toString()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDLancReceber.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDLancReceber dialog = new JDLancReceber(new javax.swing.JFrame(), true);
