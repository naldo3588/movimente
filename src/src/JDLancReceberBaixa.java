 ...
 */
public class JDLancReceberBaixa extends javax.swing.JDialog {
     ...
     */
    public JDLancReceberBaixa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
//        lookandfell();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Lançamento de Contas a Receber", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
    ...
    private void jButtonBaixar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBaixar1ActionPerformed
        ...
        if (jTableFaturas.getValueAt(linha, 0) == null) {
            ...
            try {
                ...
                receber.setId_contas_receber(id);
    ...
    private void jButtonLimpar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLimpar1ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        JDLancReceberBaixa baixa = new JDLancReceberBaixa(null, rootPaneCheckingEnabled);
        ...
        if (option == JOptionPane.YES_OPTION) {
            ...
            if (validarCampos() == false) {
                ...
                try {
                    ...
                    conta.setTipo_entrada(jComboBoxTipoSaida.getSelectedItem().toString());
...
//                    this.dispose();
//                    JDLancReceber lancPagar = new JDLancReceber(null, rootPaneCheckingEnabled);
...
//            jFormattedTextFieldCPFBusca.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDLancReceberBaixa.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDLancReceberBaixa dialog = new JDLancReceberBaixa(new javax.swing.JFrame(), true);
