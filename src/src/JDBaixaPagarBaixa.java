 ...
 */
public class JDBaixaPagarBaixa extends javax.swing.JDialog {
     ...
     */
    public JDBaixaPagarBaixa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                JOptionPane.showMessageDialog(null, "Nenhum resultado encontrado!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDBaixaPagarBaixa.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDBaixaPagarBaixa dialog = new JDBaixaPagarBaixa(new javax.swing.JFrame(), true);
